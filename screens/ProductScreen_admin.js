        ...
        const fetchUserData = async () => {
            try {
                ...
                if (storedUsername) {
                    ...
                    console.log('Stored Username:', trimmedUsername);
                    console.log('Is Admin:', trimmedUsername === 'admin');
                }
            } catch (error) {
    ...
    return (
        <View style={styles.container}>
                                ...
                                <TouchableOpacity style={styles.button} onPress={() => handleAddToCart(product)}>
                                    ...
                                    <View style={styles.adminActions}>
                                        <TouchableOpacity
                                            ...
                                            onPress={() => navigation.navigate('Atualizar Produto', { product, onUpdateProduct: handleUpdateProduct })}
                                        >
            ...
            <View style={styles.checkoutButton}>
                <TouchableOpacity style={[styles.button, styles.adminButton]} onPress={() => navigation.navigate('Registro de Produtos')}>
...
const styles = StyleSheet.create({
    ...
    adminButton: {
        backgroundColor: '#708090', // Cor distinta para as ações de admin
    },
    noProducts: {
        textAlign: 'center',
        fontSize: 18,
